...
<body>
<nav class="navbar navbar-light" style="background-color:#0A2F5C">
        <div class="container">
                ...
                <ul class="nav navbar-nav">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="/vac/monse01.php">pagina 1</a><br>
                            <a class="dropdown-item" href="/vac/monse02.php">pagina 2</a><br>
                            <a class="dropdown-item" href="/vac/monse03.php">pagina 3</a><br>
                        </div>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="/vac/monse04.php">pagina 4</a><br>
                            <a class="dropdown-item" href="/vac/monse05.php">pagina 5</a><br>
                            <a class="dropdown-item" href="/vac/monse06.php">pagina 6</a><br>
                        </div>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="/vac/pokemon.html">Pokedex</a><br>
                            <a class="dropdown-item" href="/vac/peliclas.html">Peliculas API</a><br>
                            <a class="dropdown-item" href="/vac/dragon ball9.html">Dragon Ball API</a><br>
                            <a class="dropdown-item" href="/vac/final.html">Harry Potter API</a><br>
